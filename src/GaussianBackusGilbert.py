...
def GaussianBGM_solve(A, b, C, omegas, taus, sigma=1e-2, eps=1e-6, lam_input=-1, Nlam=100, spacing='log', delta=1e-8, periodic=-1):
    """
    ...
    for i in range(Nomega):
        ...
        g_list.append(g)
        x[i]=(dw*b.T @ g)[0,0];
    return reshape(x, (Nomega,1)), g_list, obj_list, smearing_list
